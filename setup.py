...
setup(
    ...
    description='Python module that parses XML config files with defined structure.',
    ...
    # Author details
    author='Simon Let',
    author_email='simon.a.let@gmail.com',
